...
public class BalanceInquiry extends HttpServlet {
	...
	private void balanceInquiry() {
		...
		out.println("<html><body>" + "Account Number :" + customer.getBankAccount().getAccountNumber()
				+ "<br></body></html>");
		out.println("<html><body>" + "Balance :" + customer.getBankAccount().getBalance() + "<br></body></html>");
